# Qwen/Qwen3-0.6B
This folder contains a sample use case of Olive to optimize and quantize [Qwen/Qwen3-0.6B](https://huggingface.co/Qwen/Qwen3-0.6B) model using existing tools.
...
## Config file 
The workflow in Config file: [qwen3-0.6B_Spinquant_INC_RTN_4bit.json](qwen3-0.6B_Spinquant_INC_RTN_4bit.json) executes the above workflow.
...
```bash
olive run --config qwen3-0.6B_Spinquant_INC_RTN_4bit.json
```
...
olive_run("qwen3-0.6B_Spinquant_INC_RTN_4bit.json")
```
